...
const notificationSlice = createSlice({
    ...
    reducers:{
        ...
        setThirdPersonCustomerDialog: (state,action) => {
            state.thirdPersonCustomerDialog = action.payload;
        },
        ...
        setTrialBalanceTransactionDialog: (state,action) => {
            state.trialBalanceTransactionDialog = action.payload;
        },
        ...
        setColumnHeaderWarningDialog: (state,action) => {
            state.columnHeaderWarningDialog = action.payload;
        },
        setColumnHeaderInfoDialog: (state,action) => {
            state.columnHeaderInfoDialog = action.payload;
        },
