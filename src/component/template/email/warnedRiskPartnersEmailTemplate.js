const warnedRiskPartnersEmailTemplate = ({ subject = '', project = '', tutar = '' }) => `
		...
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" class="container" width="700">
				<tbody>
					...
					<tr>
						<td align="center" class="ortala" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; text-align:left; padding:5px;">%%proje%% projesinde bulunan %%sozlesme%% numaralı s&ouml;zleşmenizin %%tutar%% TL &ouml;denmemiş taksiti bulunmaktadır. Takip s&uuml;recindeki &ouml;demenizi ger&ccedil;ekleştirmenizi rica ederiz.&nbsp;Bug&uuml;n itibari ile ihtarname s&uuml;reci başlatılmıştır.<br />
						<br />
...
export default warnedRiskPartnersEmailTemplate;
