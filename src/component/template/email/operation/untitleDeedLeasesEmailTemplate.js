const riskPartnersEmailTemplate = ({ subject = '', project = '', tutar = '' }) => `
		...
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" class="container" width="700">
				<tbody>
					...
					<tr>
						<td align="center" class="ortala" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; text-align:left; padding:5px;">Sinpaş projesinde bulunan %%sozlesme%% numaralı s&ouml;zleşmenizin %%tutar%% TL &ouml;denmemiş taksiti bulunmaktadır. Bug&uuml;n &ouml;denmesi hususunda gereğini rica ederiz. &Ouml;demelerinizi online sistemden kontrol edip &ouml;deme yapabilirsiniz.<br />
						<br />
...
export default riskPartnersEmailTemplate;
