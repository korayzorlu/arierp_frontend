...
import { sendSMS, sendSMSGlobal, setSMSsLoading } from 'store/slices/communication/smsSlice';
import SendIcon from '@mui/icons-material/Send';

function SendSMSGlobalDialog({...props}) {
...
export default SendSMSGlobalDialog
