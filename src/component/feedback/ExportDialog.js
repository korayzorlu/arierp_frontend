...
function ExportDialog(props) {
    const {children,excelURL,exportURL,startEvent,finalEvent,closeEvent,file_name,project,status,date,is_special,lease} = props;
    ...
    const handleExport = async () => {
        ...
        try {
            const response = await axios.post(exportURL,
                {project,status,date,is_special,lease},
                { 
