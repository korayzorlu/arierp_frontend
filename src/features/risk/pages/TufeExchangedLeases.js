...
function TufeExchangedLeases() {
    ...
    const columns = [
        ...
        { field: 'odenmesi_gereken_yerel', headerName: 'Ödenmesi Gereken', width:180, type: 'number', renderHeaderFilter: () => null,
            renderCell: (params) =>  new Intl.NumberFormat('tr-TR', { minimumFractionDigits: 2,maximumFractionDigits: 2,}).format(params.value)
        },
        { field: 'tufe_odenmesi_gereken', headerName: 'Tüfeli Ödenmesi Gereken', width:200, type: 'number', renderHeaderFilter: () => null,
            renderCell: (params) =>  new Intl.NumberFormat('tr-TR', { minimumFractionDigits: 2,maximumFractionDigits: 2,}).format(params.value)
        },
        { field: 'odenen_yerel', headerName: 'Ödenen', width:120, type: 'number', renderHeaderFilter: () => null,
            renderCell: (params) =>  new Intl.NumberFormat('tr-TR', { minimumFractionDigits: 2,maximumFractionDigits: 2,}).format(params.value)
        },
        { field: 'tufe_odenen', headerName: 'Tüfeli Ödenen', width:180, type: 'number', renderHeaderFilter: () => null,
            renderCell: (params) =>  new Intl.NumberFormat('tr-TR', { minimumFractionDigits: 2,maximumFractionDigits: 2,}).format(params.value)
        },
