...
function ToTerminatedRiskPartners() {
    ...
    const {toTerminatedRiskPartners,toTerminatedRiskPartnersCount,toTerminatedRiskPartnersParams,toTerminatedRiskPartnersLoading,partnerNotesParams} = useSelector((store) => store.riskPartner);
