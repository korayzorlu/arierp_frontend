        ...
        <PanelContent>
            ...
            customButtons={
                <>  
                    <CustomTableButton
                    title="Excel'e Aktar"
                    onClick={() => {dispatch(setExportDialog(true));dispatch(fetchExportProcess());setExportURL(`/leasing/export_title_deed_confirms/`)}}
                    icon={<DownloadIcon fontSize="small"/>}
                    />
                    <CustomTableButton
                    title="Yenile"
                    onClick={() => dispatch(fetchTitleDeedConfirms({activeCompany,params:titleDeedConfirmsParams})).unwrap()}
            ...
            templateURL="/leasing/titleDeedConfirms_template"
            importURL="/leasing/import_titleDeedConfirms/"
            startEvent={() => dispatch(setTitleDeedConfirmsLoading(true))}
            finalEvent={() => {dispatch(fetchTitleDeedConfirms({activeCompany}));dispatch(setTitleDeedConfirmsLoading(false));}}
            >

            </ImportDialog>
            <DeleteDialog
            handleClose={() => dispatch(setDeleteDialog(false))}
            deleteURL="/leasing/delete_titleDeedConfirms/"
