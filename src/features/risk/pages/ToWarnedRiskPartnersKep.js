...
function ToWarnedRiskPartnersKep() {
    ...
    const {kepToWarnedRiskPartners,kepToWarnedRiskPartnersCount,kepToWarnedRiskPartnersParams,kepToWarnedRiskPartnersLoading,partnerNotesParams} = useSelector((store) => store.riskPartner);
...
export default ToWarnedRiskPartnersKep
