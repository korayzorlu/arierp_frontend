...
function ToWarnedRiskPartnersDeposit() {
    ...
    const {depositeToWarnedRiskPartners,depositeToWarnedRiskPartnersCount,depositeToWarnedRiskPartnersParams,depositeToWarnedRiskPartnersLoading} = useSelector((store) => store.riskPartner);
