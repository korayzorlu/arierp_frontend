...
function ToWarnedRiskPartnersDeposit() {
    ...
    useEffect(() => {
        startTransition(() => {
            dispatch(fetchToWarnedRiskPartners({activeCompany,params:{...toWarnedRiskPartnersParams,project,type:'kapora'}}))
        });
            ...
            <Grid container spacing={1}>
                ...
                customButtons={
                    <>
                        ...
                        <CustomTableButton
                        title="Yenile"
                        onClick={() => dispatch(fetchToWarnedRiskPartners({activeCompany,params:{...toWarnedRiskPartnersParams,project,type:'kapora'}})).unwrap()}
