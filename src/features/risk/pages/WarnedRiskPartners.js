...
function WarnedRiskPartners() {
    ...
    const {warnedRiskPartners,warnedRiskPartnersCount,warnedRiskPartnersParams,warnedRiskPartnersLoading,partnerNotesParams} = useSelector((store) => store.riskPartner);
