...
function WarnedRiskPartnerDetailPanel(props) {
    ...
    const {warnedRiskPartnersParams} = useSelector((store) => store.riskPartner);
    ...
    const columns = [
            ...
            renderCell: (params) => {
                ...
                return (
                    <Stack direction="row" spacing={1} sx={{alignItems: "center",height:'100%',}}>
                        <Button variant='contained' color={dark ? 'mars' : 'mars'} endIcon={<PaidIcon/>} size='small' onClick={()=>{dispatch(fetchContractPaymentsInLease({activeCompany,contract_uuid:params.row.contract_uuid}));dispatch(setContractPaymentDialog(true))}}>
                            Detay
                        </Button>
                    </Stack>
        ...
        { field: '-trade_transactions', headerName: 'Cari Ekstre', flex:2,
            renderCell: (params) => {
                ...
                return (
                    <Stack direction="row" spacing={1} sx={{alignItems: "center",height:'100%',}}>
                        <Button variant='contained' color={dark ? 'mars' : 'mars'} endIcon={<ReceiptLongIcon/>} size='small' onClick={()=>{dispatch(fetchTradeTransactionsInLease({activeCompany,lease_uuid:params.row.id}));dispatch(setTradeTransactionDialog(true))}}>
                            Detay
                        </Button>
                    </Stack>
        ...
        { field: 'i', headerName: 'İhtar', flex: 2, renderCell: (params) => (
                ...
                ?
                    <Stack direction="row" spacing={1} sx={{alignItems: "center",height:'100%',}}>
                        <Button variant='contained' color={dark ? 'mars' : 'mars'} endIcon={<FeedIcon/>} size='small' onClick={() => handleWarningNoticeDialog(params.row.contract)}>
                            Detay
                        </Button>
                    </Stack>
                :
