...
import { setComprehensiveWarningNoticeDialog, setContractPaymentDialog, setInstallmentDialog, setPartnerDialog, setTradeTransactionDialog, setWarningNoticeDialog } from 'store/slices/notificationSlice';
...
function MonthlyWarnedRiskPartnerDetailPanel(props) {
    ...
    const columns = [
        ...
        //     )
        // },
        { field: 'annual_wn_count', headerName: 'İhtar Sayısı', flex: 2, type: 'number'},
        { field: 'i', headerName: 'İhtar', flex: 2, renderCell: (params) => (
                params.row.status === "İhtar Çekildi"
                ?
                    <Stack direction="row" spacing={1} sx={{alignItems: "center",height:'100%',}}>
...
export default MonthlyWarnedRiskPartnerDetailPanel
