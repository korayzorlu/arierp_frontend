...
import { fetchActiveLeases, resetActiveLeasesParams, setActiveLeasesLoading, setActiveLeasesParams } from '../../../store/slices/leasing/leaseSlice';
...
function ActiveActiveLeases() {
    ...
    const {activeLeases,activeLeasesCount,activeLeasesParams,activeLeasesLoading} = useSelector((store) => store.lease);
    ...
    return (
        <PanelContent>
            ...
            finalEvent={() => {dispatch(fetchActiveLeases({activeCompany}));dispatch(setActiveLeasesLoading(false));}}
            >

            </ImportDialog>
            <DeleteDialog
            handleClose={() => dispatch(setDeleteDialog(false))}
            deleteURL="/leasing/delete_activeLeases/"
...
export default ActiveActiveLeases
