...
function TicariPartners() {
    ...
    useEffect(() => {
        startTransition(() => {
            dispatch(fetchPartners({activeCompany,params:{...partnersParams,is_commercial:true}}));
        });
    ...
    return (
        <PanelContent>
            <ListTableServer
            title="Ticari Müşteriler Listesi"
            rows={partners}
            columns={columns}
